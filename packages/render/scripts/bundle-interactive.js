...
export async function bundleInteractive() {
 ...
 */
export async function loadInteractiveBundle() {
    try {
 ...
 */
export function wrapInScriptTag(jsCode) {
    return `<script>\n${jsCode}\n</script>`;
}
// ── CLI entry point ─────────────────────────────────────────────────
...
//# sourceMappingURL=bundle-interactive.js.map